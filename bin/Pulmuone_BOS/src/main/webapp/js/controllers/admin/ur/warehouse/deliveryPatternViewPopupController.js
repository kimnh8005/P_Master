...
$(document).ready(function() {
    ...
    function fnInitialize(){
        ...
        fnPageInfo({
            PG_ID  : "deliveryPatternViewPopup",
            callback : fnUI
        });
    };
    ...
    function fnViewModelInit(){
        ...
        viewModel = new kendo.data.ObservableObject({
        	warehouseResultTemplate : { // 출고처 정보
                warehouseName : "",
                warehouseGroupName : ""
            },
            shippingTemplateList : [] // 배송정책 리스트
    ...
    function fnSetData(){
        ...
        searchParam.urWarehouseId = paramData.urWarehouseId;

        fnAjax({
            url     : "/admin/ur/warehouse/getShippingTemplate",
            params  : searchParam,
            contentType : "application/json",
            success :
                function( data ){

                    viewModel.set("warehouseResultTemplate", data.warehouseResultTemplate);
                    viewModel.set("shippingTemplateList", data.shippingTemplateList);
                },
            isAction : "select"
        });
    };
