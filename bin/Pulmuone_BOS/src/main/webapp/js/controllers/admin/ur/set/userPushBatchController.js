...
//        fnSearch();
	...
	function fnInitButton(){
		$("#fnSearch, #fnClear, #fnSearchUserPushSend, #fnSearchUserPushSend, #fnImageUpload").kendoButton();
	};
...
//        if( $("#searchClassification").val() == "USER_NAME" ){
//            if( searchClassificationTextareaTrimReplaceValue == "" ){
//                $("#searchClassificationTextareaValue").val("");
//                return fnAlertMessage("회원명 을 입력해 주시기 바랍니다.", "searchClassificationTextareaValue");
//            }
//        }
//
//        if( $("#searchClassification").val() == "LOGIN_ID" ){
//            if( searchClassificationTextareaTrimReplaceValue == "" ){
//                $("#searchClassificationTextareaValue").val("");
//                return fnAlertMessage("회원ID 를 입력해 주시기 바랍니다.", "searchClassificationTextareaValue");
//            }
//        }
...
//            if( $.trim($("#mobile").val()) == "" ){
//                $("#mobile").val("");
//                return fnAlertMessage("휴대폰번호 를 입력해 주시기 바랍니다.", "mobile");
//            }
//
//            if( fnValidatePhone($("#mobile").val()) == false ){
//                return fnAlertMessage("올바른 휴대폰번호가 아닙니다.", "mobile");
//            }
//        }
//
//        if( $("#mail").val() != ""){
//            if( $.trim($("#mail").val()) == "" ){
//                $("#mail").val("");
//                return fnAlertMessage("EMAIL 을 입력해 주시기 바랍니다.", "mail");
//            }
//
//            if( fnValidateEmail($("#mail").val()) == false ){
//                return fnAlertMessage("올바른 EMAIL 이 아닙니다.", "mail");
//            }
//        }
    ...
    function fnInitGrid(){
        ...
        aGridOpt = {
            ...
            columns   : [
                        ...
                        , {field : 'userTypeName',	 title : '회원유형', width : '60px', attributes : {style : 'text-align:center'}, template: "#=(userTypeName=='관리자') ? '임직원' : '일반'#"}
    ...
    function fnInitOptionBox() {
        //-------------------------------  메인화면 Function start -------------------------------
        // 검색구분
//        var searchClassificationDrop = fnKendoDropDownList({
...
//        searchClassificationDrop.bind('change', function() {
//            fnSearchControl();
//        });
    ...
    function fnInputFormSubmit(url, userDataArray, cbId){
        ...
        let searchForm = {};
        let searchFormData = $("#searchForm").formSerialize(true);
        searchForm.condiType = searchFormData.condiType;
        searchForm.condiValue = searchFormData.condiValue;
        searchForm.userLevel = searchFormData.userLevel;
        searchForm.joinDateStart = searchFormData.joinDateStart;
        searchForm.joinDateEnd = searchFormData.joinDateEnd;
        searchForm.lastVisitDateStart = searchFormData.lastVisitDateStart;
        searchForm.lastVisitDateEnd = searchFormData.lastVisitDateEnd;
        inputFormData['searchForm']= searchForm;
