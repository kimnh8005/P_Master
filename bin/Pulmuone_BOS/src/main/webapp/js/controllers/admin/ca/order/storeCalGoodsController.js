/**-----------------------------------------------------------------------------
 * description 		 : 정산관리 > 주문정산 > 매장 상품 정산 내역
* **/
"use strict";
...
var defaultGridUrl = "/admin/calculate/order/getStoreGoodsList";
...
$(document).ready(function() {
	...
	// 그리드 초기화
	function fnInitGrid(){
		calOrderGridEventUtil.gridInit(defaultGridUrl, calOrderGridUtil.storeCalGoodsList());
...
//	};
	...
	$scope.fnExcelDownload =function(){
		var url = "/admin/calculate/order/getStoreGoodsListExportExcel";
