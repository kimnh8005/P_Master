...
$(document).ready(function() {
	...
	function fnInitialize(){
		...
		fnPageInfo({
			PG_ID  : 'policyExcelMasterItemTmplt',
			callback : fnUI
		});
	};
	...
	function fnInitButton(){
		$('#fnSave, #fnClear, #fnGridAdd, #fnGridDel, #fnGridAddNull, #fnDelInit').kendoButton();
	...
	function fnClear(){
		...
		aGridDs.read({"stCommonCodeMasterId" : "EXCEL_TEMPLATE_ITEM", "useYn" : "Y"});
	...
	function fnSave(){
		...
		*/
		...
		data["urCompanyId"] =  "1";
		data["excelTemplateTp"] =  "EXCEL_TEMPLATE_TP.MASTER_ITEM";
	...
	function fnInitOptionBox(){
        ...
        fnKendoDropDownList({
        	...
        	params : { "excelTemplateTp" : "EXCEL_TEMPLATE_TP.MASTER_ITEM"},
	...
	function fnInitGrid(){
		...
		aGridOpt = {
			...
			,columns : [{ field:'dictionaryMasterName'		,title : '항목명'	, width:'75%', attributes:{ style:'text-align:left' }}
