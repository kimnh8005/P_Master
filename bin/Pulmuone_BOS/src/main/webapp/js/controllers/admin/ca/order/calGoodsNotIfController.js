/**-----------------------------------------------------------------------------
 * description 		 : 정산관리 > 주문정산 > 상품 정산 내역 (IF 아닌)
 * @
 * @ 수정일			수정자          수정내용
 * @ ------------------------------------------------------
 * @ 2021.03.03		이명수          최초생성
...
var defaultGridUrl = "/admin/calculate/order/getGoodsNotIfList";
...
$(document).ready(function() {
	...
	// 그리드 초기화
	function fnInitGrid(){
		calOrderGridEventUtil.gridInit(defaultGridUrl, calOrderGridUtil.calGoodsNotIfList());
...
//	};
	...
	$scope.fnExcelDownload =function(){
		var url = "/admin/calculate/order/getGoodsNotIfListExportExcel";
