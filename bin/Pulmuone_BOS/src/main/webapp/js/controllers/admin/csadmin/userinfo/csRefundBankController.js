...
'use strict';
	...
	var defaultActivateTab = "CS_REFUND";
	...
	importScript(
			...
			function() {
				...
				getContentsHtmlByPath(
					...
					fnPageInfo({PG_ID  : 'csRefundBank'});

					$('#csRefundContents').append(csPlugin.emptyContents());
					//$('#csRefundContents').append(csPlugin.emptyMessageContents());
				}
