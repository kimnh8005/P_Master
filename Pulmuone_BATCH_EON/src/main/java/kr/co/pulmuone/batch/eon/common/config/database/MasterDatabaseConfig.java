...
@MapperScan(
        ...
        basePackages = {
                "kr.co.pulmuone.batch.eon.infra.mapper.system"
                , "kr.co.pulmuone.batch.eon.infra.mapper.send"
                , "kr.co.pulmuone.batch.eon.infra.mapper.sample.master"
                , "kr.co.pulmuone.batch.eon.infra.mapper.email.master"
        }
)
