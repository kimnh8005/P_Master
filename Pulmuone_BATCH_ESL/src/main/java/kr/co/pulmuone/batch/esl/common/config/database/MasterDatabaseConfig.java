...
@MapperScan(
        ...
        basePackages = {
                "kr.co.pulmuone.batch.esl.infra.mapper.system"
                , "kr.co.pulmuone.batch.esl.infra.mapper.send"
                , "kr.co.pulmuone.batch.esl.infra.mapper.sample.master"
                , "kr.co.pulmuone.batch.esl.infra.mapper.order.master"
        }
)
