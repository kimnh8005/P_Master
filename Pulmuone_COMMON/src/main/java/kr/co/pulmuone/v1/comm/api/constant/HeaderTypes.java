...
public enum HeaderTypes implements CodeCommEnum { // ( ERP API ) 입력 시스템 코드 Enum
    ...
    public static final String CODE_KEY = "hdrTyp";
    ...
    public static HeaderTypes deserializeToEnumByCode( //
            @JsonProperty(HeaderTypes.CODE_KEY) String code // ERP API 에서 전송한 법인코드
    ) {
        ...
        return EnumUtil.getEnum(HeaderTypes.class, code);
