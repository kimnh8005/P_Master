...
public class UidUtil implements Serializable {
    /*
     ...
     * @param leastSigBits
     */
    public UidUtil(long mostSigBits, long leastSigBits) {
     ...
     */
    public static UidUtil randomUUID() {
        ...
        return new UidUtil(randomBytes);
    }
     ...
     */
    public static UidUtil nameUUIDFromBytes(byte[] name) {
        MessageDigest md;
        try {
     ...
     */
    public static UidUtil fromString(String name) {
        ...
        return new UidUtil(mostSigBits, leastSigBits);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof UidUtil))
            return false;
        if (((UidUtil) obj).variant() != this.variant())
            return false;
        UidUtil id = (UidUtil) obj;
     ...
     */
    public int compareTo(UidUtil val) {
