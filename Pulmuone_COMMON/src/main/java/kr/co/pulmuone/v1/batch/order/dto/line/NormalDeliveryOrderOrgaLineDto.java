...
@Setter
@ToString
@ApiModel(description = "NormalDeliveryOrderOrgaLineDto")
public class NormalDeliveryOrderOrgaLineDto {
    ...
    @Builder
    public NormalDeliveryOrderOrgaLineDto(String crpCd, String hrdSeq, String oriSysSeq, String ordNoDtl, String ordNum, String erpItmNo,
