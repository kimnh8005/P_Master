...
@Setter
@ToString
@ApiModel(description = "BabymealNormalOrderLineDto")
public class BabymealNormalOrderLineDto {
    ...
    @Builder
    public BabymealNormalOrderLineDto(String crpCd, String hrdSeq, String oriSysSeq, String ordNoDtl, String ordNum,
                                      String erpItmNo, String malItmNo, Integer ordCnt, String dlvReqDat, double stdPrc,
                                      double selPrc, String dlvGrp, String creDat, String age, String taxYn, String onDlvCd) {
        this.crpCd = crpCd;
        this.hrdSeq = hrdSeq;
