...
@Setter
@ToString
@ApiModel(description = "OrgaStoreDeliveryOrderHeaderDto")
public class OrgaStoreDeliveryOrderHeaderDto {
    ...
    @Builder
    public OrgaStoreDeliveryOrderHeaderDto(String srcSvr, String hrdSeq, String oriSysSeq, String hdrTyp, String ordNum, String ordNam,
                                           ...
                                           //Integer totSalAmt, Integer totDcAmt, Integer dcmSalAmt, Integer vatSalAmt, Integer vatAmt, Integer noVatSalAmt, Integer noTaxSalAmt,
