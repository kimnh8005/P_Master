 ...
 * <PRE>
 * Forbiz Korea
 * 주문 녹즙/잇슬림/베이비밀 스캐줄  관련 Interface
 * </PRE>
 *
 * <PRE>
 * <B>History:</B>
 ...
 *  1.1		2021. 01. 29.	이규한		주문 스케줄 리스트 Request 정보 조회 추가
 * =======================================================================
 * </PRE>
 */
@Slf4j
...
public class OrderScheduleService {
	...
	public OrderDetailScheduleListRequestDto getOrderScheduleRequestInfo(Long odOrderDetlId) {
		return orderDetailScheduleMapper.getOrderScheduleRequestInfo(odOrderDetlId);
	}
	...
	public OrderDetailScheduleGoodsDto getOrderScheduleSelectGoodsInfo(Long odOrderId) {
		return orderDetailScheduleMapper.getOrderScheduleSelectGoodsInfo(odOrderId);
	}
	...
	public OrderDetailScheduleGoodsDto getOrderScheduleGoodsInfo(Long odOrderDetlId) {
		return orderDetailScheduleMapper.getOrderScheduleGoodsInfo(odOrderDetlId);
	}
	...
	public OrderDetailScheduleGoodsDto getOrderScheduleGoodsBaseInfo(Long odOrderDetlId) {
		return orderDetailScheduleMapper.getOrderScheduleGoodsBaseInfo(odOrderDetlId);
	}
    ...
    protected List<OrderDetailScheduleListDto> getOrderDetailScheduleList(OrderDetailScheduleListRequestDto orderDetailScheduleListRequestDto) {
    	return orderDetailScheduleMapper.getOrderDetailScheduleList(orderDetailScheduleListRequestDto);
    }

    /**
     * 주문 녹즙 건너뛰기 스캐줄 리스트 조회
     * @param odOrderId
     * @return
     */
    protected List<OrderDetailScheduleListDto> getOrderDetailScheduleSkipList(OrderDetailScheduleSkipListRequestDto orderDetailScheduleSkipListRequestDto) {
    	return orderDetailScheduleMapper.getOrderDetailScheduleSkipList(orderDetailScheduleSkipListRequestDto);
    }
    ...
    protected List<OrderDetailScheduleDayOfWeekListDto> getOrderDetailScheduleDayOfWeekList(OrderDetailScheduleUpdateRequestDto orderDetailScheduleUpdateRequestDto) {
    	return orderDetailScheduleMapper.getOrderDetailScheduleDayOfWeekList(orderDetailScheduleUpdateRequestDto);
    }
    ...
    protected int getOrderDetailScheduleOrderCnt(OrderDetailScheduleUpdateRequestDto orderDetailScheduleUpdateRequestDto) {
    	return orderDetailScheduleMapper.getOrderDetailScheduleOrderCnt(orderDetailScheduleUpdateRequestDto);
    }
    ...
    protected int addOrderDetlSchedule(List<OrderDetlScheduleVo> insertScheduleList) {
        return orderDetailScheduleMapper.addOrderDetailSchedule(insertScheduleList);
    }
    ...
    protected int putOrderDetlSchedule(List<OrderDetlScheduleVo> updateScheduleList) {
        return orderDetailScheduleMapper.putOrderDetlSchedule(updateScheduleList);
    }
    ...
    protected int putErpOrderDetlSchedule(List<OrderDetlScheduleVo> updateScheduleList) {
        return orderDetailScheduleMapper.putErpOrderDetlSchedule(updateScheduleList);
    }
    ...
    protected String getOrderDetlScheduleHolidayYn(String nowDate) {
        return orderDetailScheduleMapper.getOrderDetlScheduleHolidayYn(nowDate);
    }
    ...
    protected int addChangeOrderDetailSchedule(OrderDetlScheduleVo orderDetlScheduleVo) {
        return orderDetailScheduleMapper.addChangeOrderDetailSchedule(orderDetlScheduleVo);
    }
    ...
    protected int addSkipOrderDetailSchedule(OrderDetlScheduleVo orderDetlScheduleVo) {
        return orderDetailScheduleMapper.addSkipOrderDetailSchedule(orderDetlScheduleVo);
    }
    ...
    protected int putSkipOrderDetailSchedule(List<OrderDetailScheduleListDto> updateScheduleList) {
        return orderDetailScheduleMapper.putSkipOrderDetailSchedule(updateScheduleList);
    }
    ...
    protected List<OrderDetailGreenJuiceListDto> getOrderDetailGreenJuiceList(Long odOrderDetlId) {
		return orderDetailScheduleMapper.getOrderDetailGreenJuiceList(odOrderDetlId);
	}
    ...
    protected String getOrderDetailBatchInfo(Long odOrderDetlId) {
		return orderDetailScheduleMapper.getOrderDetailBatchInfo(odOrderDetlId);
	}
    ...
    protected OrderDetailScheduleListDto getOrderDetailScheduleArrivalInfo(Long odOrderDetlId, String changeDate, Long odOrderDetlDailySchId) {
		return orderDetailScheduleMapper.getOrderDetailScheduleArrivalInfo(odOrderDetlId, changeDate, odOrderDetlDailySchId);
	}
    ...
    protected int getOrderDetailDailySchSeq(Long odOrderDetlId) {
		return orderDetailScheduleMapper.getOrderDetailDailySchSeq(odOrderDetlId);
	}
    ...
    protected long getOdOrderDetlId(Long odOrderDetlDailySchId) {
		return orderDetailScheduleMapper.getOdOrderDetlId(odOrderDetlDailySchId);
	}
    ...
    protected List<OrderDetailGreenJuiceListDto> getErpOrderDetailScheduleList(Long odOrderDetlId, int odOrderDetlDailySchSeq, Long odOrderDetlDailySchId) {
    	return orderDetailScheduleMapper.getErpOrderDetailScheduleList(odOrderDetlId, odOrderDetlDailySchSeq, odOrderDetlDailySchId);
    }

    /**
     * 주문 녹즙 ERP 전송 스캐줄 리스트 조회 - 적용일자 기준
     * @param odOrderDetlId
     * @param deliveryDt
     * @return
     */
    protected List<OrderDetailGreenJuiceListDto> getErpOrderDetailScheduleListByDeliveryDt(long odOrderDetlId, String deliveryDt) {
    	return orderDetailScheduleMapper.getErpOrderDetailScheduleListByDeliveryDt(odOrderDetlId, deliveryDt);
    }
    ...
    protected int delOdOrderDetlDailySch(OrderDetlScheduleVo orderDetlScheduleVo) {
		return orderDetailScheduleMapper.delOdOrderDetlDailySch(orderDetlScheduleVo);
	}
    ...
    protected OrderDetailScheduleInfoDto getOrderDetailScheduleInfo(Long odOrderDetlId, Long odOrderDetlDailySchId) {
		return orderDetailScheduleMapper.getOrderDetailScheduleInfo(odOrderDetlId, odOrderDetlDailySchId);
	}
    ...
    protected List<String> getOrderDetailScheduleDayOfWeekInfo(Long odOrderDetlId, String changeDate) {
		return orderDetailScheduleMapper.getOrderDetailScheduleDayOfWeekInfo(odOrderDetlId, changeDate);
	}
    ...
    protected int putOrderDetlSchedulePattern(Long odOrderDetlId, String deliveryDayOfWeekList) {
        return orderDetailScheduleMapper.putOrderDetlSchedulePattern(odOrderDetlId, deliveryDayOfWeekList);
    }
    ...
    protected List<OrderDetailScheduleDateInfoDto> getOrderDetailScheduleDeliveryDt(Long odOrderDetlId) {
        return orderDetailScheduleMapper.getOrderDetailScheduleDeliveryDt(odOrderDetlId);
    }
    ...
    protected OrderDetailScheduleShippingInfoDto getOrderDetailScheduleShippingInfo(Long odOrderDetlId, Long odShippingZoneId) {
        return orderDetailScheduleMapper.getOrderDetailScheduleShippingInfo(odOrderDetlId, odShippingZoneId);
    }
...
//		return drnkPtrn;
    ...
    /**
     * @Desc ( ERP 주문|취소 조회 API ) 주문정보 ERP API 에서 변경된 모든 ERP 녹즙 정보 조회
     *
     * @param hdrType
     *
     * @return List<ErpIfCustordSearchResponseDto> : ERP 연동 API 를 통해 조회된 녹즙 주문 목록
     */
    protected BaseApiResponseVo getErpCustordApiAllList(String hdrType) {
     ...
     * @return
     */
	protected int putOrderDetlDailyZone(Long odOrderDetlId,Long odOrderId){
	    return orderDetailScheduleMapper.putOrderDetlDailyZone(odOrderDetlId, odOrderId);
    }
     ...
     * @return
     */
    protected int addOrderDetlDailyZoneByOdOrderDetlId(Long odOrderDetlId, String promotionTp, Long odOrderId){
        return orderDetailScheduleMapper.addOrderDetlDailyZoneByOdOrderDetlId(odOrderDetlId, promotionTp, odOrderId);
    }
     ...
     * @return
     */
    protected void putOrderDetlDailyUrStoreId(long odOrderId, long odOrderDetlId, long odShippingZoneId) {
        orderDetailScheduleMapper.putOrderDetlDailyUrStoreId(odOrderId, odOrderDetlId, odShippingZoneId);
    }
    ...
    protected int putOrderDetlScheduleApiCancelSendYn(List<OrderDetailGreenJuiceListDto> cancelGreenJuiceList) {
        return orderDetailScheduleMapper.putOrderDetlScheduleApiCancelSendYn(cancelGreenJuiceList);
    }
}
