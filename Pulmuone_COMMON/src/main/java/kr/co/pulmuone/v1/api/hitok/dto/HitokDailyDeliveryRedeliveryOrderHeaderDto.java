...
@Setter
@ToString
@ApiModel(description = "HitokDailyDeliveryRedeliveryOrderHeaderDto")
public class HitokDailyDeliveryRedeliveryOrderHeaderDto {
    ...
    @Builder
    public HitokDailyDeliveryRedeliveryOrderHeaderDto(String srcSvr, String hrdSeq, String oriSysSeq, String hdrTyp, String ordNum, String ordHpnCd,
                                                      ...
                                                      String dlvZip, String dlvMsg, String dlvErlPwd, String dlvErlDor, String ordStuCd,
                                                      List<?> line) {
        this.srcSvr = srcSvr;
        this.hrdSeq = hrdSeq;
