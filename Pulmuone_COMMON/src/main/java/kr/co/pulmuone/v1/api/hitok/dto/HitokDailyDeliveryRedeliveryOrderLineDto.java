...
@Setter
@ToString
@ApiModel(description = "HitokDailyDeliveryRedeliveryOrderLineDto")
public class HitokDailyDeliveryRedeliveryOrderLineDto {
    ...
    @Builder
    public HitokDailyDeliveryRedeliveryOrderLineDto(String crpCd, String hrdSeq, String oriSysSeq, String ordNoDtl, String ordNum,
                                                    ...
                                                    String drnkPtrn, String prtnChnl, String taxYn) {
        this.crpCd = crpCd;
        this.hrdSeq = hrdSeq;
