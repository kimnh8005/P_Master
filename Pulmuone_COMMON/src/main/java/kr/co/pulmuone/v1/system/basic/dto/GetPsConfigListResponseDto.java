...
@Setter
@ToString
@ApiModel(description = "GetPsConfigListResponseDto")
public class GetPsConfigListResponseDto extends BaseResponseDto {

	@ApiModelProperty(value = "리스트")
	private	 List<GetPsConfigListResultVo> rows;
