...
@Setter
@ToString
@ApiModel(description = "LohasDirectSaleReturnOrderHeaderDto")
public class LohasDirectSaleReturnOrderHeaderDto {
    ...
    @Builder
    public LohasDirectSaleReturnOrderHeaderDto(String srcSvr, String hrdSeq, String oriSysSeq, String hdrTyp, String ordNum, String ordHpnCd,
