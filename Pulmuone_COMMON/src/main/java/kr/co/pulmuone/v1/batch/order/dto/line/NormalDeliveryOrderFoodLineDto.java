...
@Setter
@ToString
@ApiModel(description = "NormalDeliveryOrderFoodLineDto")
public class NormalDeliveryOrderFoodLineDto {
    ...
    @Builder
    public NormalDeliveryOrderFoodLineDto(String crpCd, String hrdSeq, String oriSysSeq, String ordNoDtl, String ordNum, String erpItmNo,
                                          Integer ordCnt, String dlvStrDat, String dlvReqDat, double selPrc, String shpItmNam, String shpCd,
                                          double totOrdAmt, double totOrdAmtNonTax, double totOrdTax, String wahCd, String ctx, String linCatCd, String linTyp,
                                          String ordPoTyp, String shiIns, Integer linTypId, Integer shiToOrgId, String ordSrc, String shiPriCd,
                                          String ordTyp, String prcDat, String taxYn) {
        this.crpCd = crpCd;
        this.hrdSeq = hrdSeq;
