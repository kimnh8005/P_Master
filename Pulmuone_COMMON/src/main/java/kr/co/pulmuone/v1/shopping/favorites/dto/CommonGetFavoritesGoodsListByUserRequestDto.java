...
@Setter
@ToString
@ApiModel(description = "CommonGetFavoritesGoodsListByUserRequestDto")
public class CommonGetFavoritesGoodsListByUserRequestDto extends MallBaseRequestPageDto {
