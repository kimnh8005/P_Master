...
@Setter
@ToString
@ApiModel(description = "HitokDeliveryOrderHeaderDto")
public class HitokDeliveryOrderHeaderDto {
    ...
    @Builder
    public HitokDeliveryOrderHeaderDto(String srcSvr, String hrdSeq, String oriSysSeq, String hdrTyp, String ordNum, String ordHpnCd,
