...
@Setter
@ToString
@ApiModel(description = "HitokNormalDeliveryOrderLineDto")
public class HitokNormalDeliveryOrderLineDto {
    ...
    @Builder
    public HitokNormalDeliveryOrderLineDto(String crpCd, String hrdSeq, String oriSysSeq, String ordNoDtl, String ordNum,
                                           String erpItmNo, Integer ordCnt, String dlvGrp, String dlvReqDat, double ordAmt,
                                           Integer totOrdCnt, String ordTyp, Integer shiToOrgId, String taxYn
                                           ) {
        this.crpCd = crpCd;
        this.hrdSeq = hrdSeq;
