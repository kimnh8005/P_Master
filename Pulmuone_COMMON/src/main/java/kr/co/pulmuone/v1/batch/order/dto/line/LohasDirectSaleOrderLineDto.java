...
@Setter
@ToString
@ApiModel(description = "LohasDirectSaleOrderLineDto")
public class LohasDirectSaleOrderLineDto {
    ...
    @Builder
    public LohasDirectSaleOrderLineDto(String crpCd, String hrdSeq, String oriSysSeq, String ordNoDtl, String ordNum,
                                       String erpItmNo, String malItmNo, Integer ordCnt, String dlvGrp, String dlvReqDat,
                                       double ordAmt, String shpItmNam, String creDat, String ordCnlFlg, String taxYn) {
        this.crpCd = crpCd;
        this.hrdSeq = hrdSeq;
