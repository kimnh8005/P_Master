...
@Getter
@Builder
@ApiModel(description = "HitokDailyDeliveryReturnOrderListVo")
public class HitokDailyDeliveryReturnOrderListVo {
    ...
    @ApiModelProperty(value = "스케줄 클레임 횟수")
    ...
    @ApiModelProperty(value = "주문 클레임 상세 일일배송 패턴 스케줄 PK")
    private String odClaimDetlDailySchId;

    @ApiModelProperty(value = "주문 클레임 상세 일일배송 패턴 스케줄 라인번호")
    private Integer odClaimDetlDailySchSeq;
