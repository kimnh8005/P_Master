...
@Setter
@ToString
@ApiModel(description = "HitokDailyDeliveryCancelOrderHeaderDto")
public class HitokDailyDeliveryCancelOrderHeaderDto {
    ...
    @Builder
    public HitokDailyDeliveryCancelOrderHeaderDto(String srcSvr, String hrdSeq, String oriSysSeq, String hdrTyp, String ordNum, String ordHpnCd,
