...
@Setter
@ToString
@ApiModel(description = "HitokDailyDeliveryCancelOrderLineDto")
public class HitokDailyDeliveryCancelOrderLineDto {
    ...
    @Builder
    public HitokDailyDeliveryCancelOrderLineDto(String crpCd, String hrdSeq, String oriSysSeq, String ordNoDtl, String ordNum,
                                                ...
                                                String drnkPtrn, String prtnChnl, String ordNoDtlCnl, String taxYn) {
        this.crpCd = crpCd;
        this.hrdSeq = hrdSeq;
