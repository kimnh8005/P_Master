...
@Setter
@ToString
@ApiModel(description = "식단 스케쥴정보 MealSchedulelListVo")
public class MealSchedulelListVo {
    ...
    public MealSchedulelListVo(MealPatternDetailListVo patternDetlVo, LocalDate deliveryDate) {
            this.patternDetlId = patternDetlVo.getPatternDetlId();
			this.patternCd = patternDetlVo.getPatternCd();
			this.mealContsCd = patternDetlVo.getMealContsCd();
			this.deliveryDate = deliveryDate;
			this.deliveryWeekCode = StoreEnums.WeekCode.findByWeekValue(deliveryDate.getDayOfWeek().getValue())
					.getCode();
    }
}
