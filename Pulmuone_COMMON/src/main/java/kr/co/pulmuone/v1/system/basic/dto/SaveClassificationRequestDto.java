...
@AllArgsConstructor
@Builder
@ApiModel(description = " SaveClassificationRequestDto")
public class SaveClassificationRequestDto extends BaseRequestDto {
    ...
    @JsonSerialize(using = ToStringSerializer.class)
    @ApiModelProperty(value = "상위분류아이디")
