...
@Setter
@ToString
@ApiModel(description = "StoreDeliveryLineDto")
public class StoreDeliveryApiLineDto {
    ...
    @Builder
    public StoreDeliveryApiLineDto(String crpCd, String hrdSeq, String oriSysSeq, String ordNoDtl, String erpItmNo, String kanCd, Integer ordCnt,
                                   String dlvReqDat, String creDat, double salFg, String taxYn, double selPrc, double stdAmt, String salYn,
