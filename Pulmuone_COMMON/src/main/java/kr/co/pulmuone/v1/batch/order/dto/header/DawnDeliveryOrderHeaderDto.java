...
@Setter
@ToString
@ApiModel(description = "DawnDeliveryOrderHeaderDto")
public class DawnDeliveryOrderHeaderDto {
    ...
    @Builder
    public DawnDeliveryOrderHeaderDto(String srcSvr, String hrdSeq, String oriSysSeq, String hdrTyp, String ordNum, String ordDat,
                                        ...
                                        String dlvErlPwd, String dlvErlDor, List<?> line) {
        this.srcSvr = srcSvr;
        this.hrdSeq = hrdSeq;
