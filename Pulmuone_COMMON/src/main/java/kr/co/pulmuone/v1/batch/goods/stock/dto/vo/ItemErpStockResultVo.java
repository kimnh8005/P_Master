...
@ToString
@Builder
public class ItemErpStockResultVo {
    ...
    private long urWarehouseId; //출고처ID

    private long restDay; //남은일수

    private long delivery; //출고 기준일

    private String ilStockDeadlineId; //출고 기준 관리ID
    ...
    private String scheduleDate; // 예정일

    private String stockType; // 재고 타입

    private long stockQuantity; // 재고 수량

    private long disposalLeftDays; // 남은 폐기예정 전환잔여일
