...
@Setter
@ToString
@ApiModel(description = "HitokDeliveryReturnOrderHeaderDto")
public class HitokDeliveryReturnOrderHeaderDto {
    ...
    @Builder
    public HitokDeliveryReturnOrderHeaderDto(String srcSvr, String hrdSeq, String oriSysSeq, String hdrTyp, String ordNum, String ordHpnCd,
