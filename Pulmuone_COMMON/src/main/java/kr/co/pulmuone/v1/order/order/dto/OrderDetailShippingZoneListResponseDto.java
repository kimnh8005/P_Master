...
public class OrderDetailShippingZoneListResponseDto extends BaseResponseDto {

    @ApiModelProperty(value = "주문 상세 배송정보 리스트")
	private	List<OrderDetlShippingZoneVo> rows;
