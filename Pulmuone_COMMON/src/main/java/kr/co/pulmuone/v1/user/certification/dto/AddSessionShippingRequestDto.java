...
@Setter
@ToString
@ApiModel(description = "AddSessionShippingRequestDto")
public class AddSessionShippingRequestDto
{

	@ApiModelProperty(value = "배송지 수령인명", required = true)
	private String receiverName;

	@ApiModelProperty(value = "배송지 우편번호", required = true)
