...
@Setter
@ToString
@ApiModel(description = "HitokDailyDeliveryOrderLineDto")
public class HitokDailyDeliveryOrderLineDto {
    ...
    @Builder
    public HitokDailyDeliveryOrderLineDto(String crpCd, String hrdSeq, String oriSysSeq, String ordNoDtl, String ordNum,
