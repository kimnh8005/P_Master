...
@Setter
@ToString
@ApiModel(description = "HitokNormalDeliveryReturnOrderLineDto")
public class HitokNormalDeliveryReturnOrderLineDto {
    ...
    @Builder
    public HitokNormalDeliveryReturnOrderLineDto(String crpCd, String hrdSeq, String oriSysSeq, String ordNoDtl, String ordNum,
                                                 String erpItmNo, Integer ordCnt, String dlvGrp, String dlvReqDat, double ordAmt,
                                                 Integer totOrdCnt, String ordTyp, Integer shiToOrgId, String ordNoDtlCnl, String taxYn, String refVal01) {
        this.crpCd = crpCd;
        this.hrdSeq = hrdSeq;
