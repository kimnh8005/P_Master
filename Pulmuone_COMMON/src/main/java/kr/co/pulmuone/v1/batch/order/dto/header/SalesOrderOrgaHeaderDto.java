...
@Setter
@ToString
@ApiModel(description = "SalesOrderOrgaHeaderDto")
public class SalesOrderOrgaHeaderDto {
    ...
    @Builder
    public SalesOrderOrgaHeaderDto(String srcSvr, String hrdSeq, String oriSysSeq, String hdrTyp, String ordNum, String ordDat,
