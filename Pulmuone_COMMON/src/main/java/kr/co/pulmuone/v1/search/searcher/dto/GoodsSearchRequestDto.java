...
public class GoodsSearchRequestDto
{
	...
	@Builder
	public GoodsSearchRequestDto(String keyword, String lev1CategoryId, String lev2CategoryId, String lev3CategoryId, String mallId
			...
			, Boolean isEmployee, String purchaseTargetType, Boolean isDiscountGoods, Integer minimumDiscountRate, Integer maximumDiscountRate)
	{
