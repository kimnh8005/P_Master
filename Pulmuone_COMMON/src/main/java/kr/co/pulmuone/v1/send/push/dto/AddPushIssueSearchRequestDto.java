...
@Getter
@Setter
@ApiModel(description = "검색회원 PUSH 발송 Request")
public class AddPushIssueSearchRequestDto extends BaseRequestDto {
    ...
    @ApiModelProperty(value = "푸시 가능 회원 조회 Request")
    GetBuyerDeviceListRequestDto searchForm;
}
