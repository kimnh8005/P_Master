...
@Setter
@ToString
@ApiModel(description = "ReturnSalesOrderOrgaLineDto")
public class ReturnSalesOrderOrgaLineDto {
    ...
    @Builder
    public ReturnSalesOrderOrgaLineDto(String crpCd, String hrdSeq, String oriSysSeq, String ordNoDtl, String ordNum,
                                       ...
                                       double totOrdAmt, double totOrdAmtNonTax, double totOrdTax, String wahCd, String ordNoDtlCnl,
                                       String ctx, String linCatCd, String linTyp, String ordPoTyp, String ordCntUom, Integer orgId, String prcDat,
                                       String prmDat,Integer recOrgId, String rtnOriSysDocRef, String rtnOriSysLinRef, String rtnRsnDes, String rtnTrcTyp,
                                       String salCnlTyp, Integer linTypId, String ordTyp, Integer shiToOrgId, String ordSrc, String taxYn, String refVal01) {
