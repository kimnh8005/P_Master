...
@MapperScan(
        ...
        basePackages = {
                "kr.co.pulmuone.batch.cj.infra.mapper.system"
                , "kr.co.pulmuone.batch.cj.infra.mapper.send"
                , "kr.co.pulmuone.batch.cj.infra.mapper.sample.master"
                , "kr.co.pulmuone.batch.cj.infra.mapper.email.master"
                , "kr.co.pulmuone.batch.cj.infra.mapper.claim.master"
