package kr.co.pulmuone.batch.cj.job.application.sample;

import kr.co.pulmuone.batch.cj.domain.model.sample.SampleMasterVo;
import kr.co.pulmuone.batch.cj.domain.service.sample.SampleMasterService;
...
@Component("sampleCjJob")
@Slf4j
@RequiredArgsConstructor
public class SampleCjJob implements BaseJob {
