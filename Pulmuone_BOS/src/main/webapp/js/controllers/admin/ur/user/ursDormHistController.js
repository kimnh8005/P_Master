...
$(document).ready(function() {
	...
	function fnInitGrid(){
		aGridDs = fnGetPagingDataSource({
			url      : '/admin/ur/UserDormant/getUserDormantHistoryList'
			,pageSize : PAGE_SIZE
		});
		aGridOpt = {
			dataSource: aGridDs
			...
			,columns   : [
				...
				,{ field:'createDate'		,title : '휴면일'		, width:'120px'	,attributes:{ style:'text-align:center' }}
				,{ field:'modifyDate'		,title : '정상전환일'	, width:'120px'	,attributes:{ style:'text-align:center' }}
