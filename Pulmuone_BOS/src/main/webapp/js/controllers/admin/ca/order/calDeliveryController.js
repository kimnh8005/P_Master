...
var defaultGridUrl = "/admin/calculate/order/getDeliveryList";
...
$(document).ready(function() {
	...
	// 그리드 초기화
	function fnInitGrid(){
		calOrderGridEventUtil.gridInit(defaultGridUrl, calOrderGridUtil.calDeliveryList());
	};
	...
	function fnInitOptionBox(){
		...
		// 기간조회
		calOrderSearchUtil.dateSearchType(calOrderOptionUtil.dateSearchDeliveryData())
		...
		// 구분
		calOrderSearchUtil.getCheckBoxLocalData(calOrderOptionUtil.optSalesDeliveryGubun);

		// 물류비 정산여부
		calOrderSearchUtil.getRadioLocalData(calOrderOptionUtil.optLogisticsCost);
		...
		// 출고처
		calOrderSearchUtil.getDropDownCommCd("warehouseGroup", "NAME", "CODE", "출고처 그룹 선택", "WAREHOUSE_GROUP", "Y");
...
//		fnExcelDownload('/admin/calculate/order/getDeliveryListExportExcel', data);
//	};
	...
	$scope.fnExcelDownload =function(){
		var url = "/admin/calculate/order/getDeliveryListExportExcel";
