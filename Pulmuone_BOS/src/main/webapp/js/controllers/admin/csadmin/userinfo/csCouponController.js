...
'use strict';
  // --------------------------------------------------------------------------
	var defaultActivateTab = "CS_COUPON";
	...
	importScript(
			...
			function() {
				...
				getContentsHtmlByPath(
					...
					fnPageInfo({PG_ID  : 'csCoupon'});

					$('#csCouponContents').append(csPlugin.emptyContents());
					$('#csCouponContents').append(csPlugin.emptyMessageContents());
				}
