...
$(document).ready(function() {
  ...
  function fnInitGrid(ctgryTp){
    ...
    gridDs = fnGetPagingDataSource({
        url      : '/admin/statics/claim/getClaimStaticsList'
      //, pageSize : PAGE_SIZE
    });
    ...
    gridOpt  = {
      ...
      , autobind    : false
      , columns     : [
                { field:'urSupplierName', title: '공급<BR>업체', width:60 , attributes:{ style:'text-align:center' }}
                , { field:'sellersGroupName', title: '판매처<BR>그룹', width: 60 , attributes:{ style:'text-align:center' }}
                , { field:'sellersName', title: '판매처', width: 60 , attributes:{ style:'text-align:center' }}
                , { field:'orderGoodsCount', title: '총 주문<BR>상품수', width: 60 , attributes:{ style:'text-align:center' }, format: '{0:\#\#,\#}'}
                , { field:'directCancelCompleteCount', title: '즉시<BR>취소', width:60 , attributes:{ style:'text-align:center'   }, format: '{0:\#\#,\#}'}
                , { title   : '취소(승인건)'
                    , columns : [
                        { field:'cancelApplyCount', title: '취소<BR>신청', width: 60 , attributes:{ style:'text-align:center'  }, format: '{0:\#\#,\#}'}
                        , { field:'cancelWithdrawalCount', title: '취소<BR>철회', width: 60 , attributes:{ style:'text-align:center'  }, format: '{0:\#\#,\#}'}
                        , { field:'cancelDenyCount', title: '취소<BR>거절', width: 60 , attributes:{ style:'text-align:center'  }, format: '{0:\#\#,\#}'}
                        , { field:'applyCancelCompleteCount', title: '취소<BR>승인', width: 60 , attributes:{ style:'text-align:center'  }, format: '{0:\#\#,\#}'}
                    ]
                }
                , { title   : '반품'
                    , columns : [
                        { field:'returnApplyCount', title: '반품<BR>신청', width: 60 , attributes:{ style:'text-align:center'  }, format: '{0:\#\#,\#}'}
                        , { field:'returnWithdrawalCount', title: '반품<BR>철회', width: 60 , attributes:{ style:'text-align:center'  }, format: '{0:\#\#,\#}'}
                        , { field:'returnDenyCount', title: '반품<BR>거절', width: 60 , attributes:{ style:'text-align:center'  }, format: '{0:\#\#,\#}'}
                        , { field:'returnIngCount', title: '반품<BR>승인', width: 60 , attributes:{ style:'text-align:center'  }, format: '{0:\#\#,\#}'}
                    ]
                }
                , { field:'exchangeCompleteCount', title: '재배송', width: 60 , attributes:{ style:'text-align:center' }, format: '{0:\#\#,\#}'}
          ]
    };
  ...
  function fnExcelDown(gubn, keyVal) {
    ...
    let url         = '/admin/statics/claim/getClaimStaticsExcelDownload';
