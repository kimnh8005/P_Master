...
@Component("systemMonitoringDailyOrderJob")
@Slf4j
public class SystemMonitoringDailyOrderJob implements BaseJob {
    /*
    배치명 : 모니터링 - 일일배송 주문 발생 여부
    배치번호 : 128
     */
    ...
    public void run(String[] params) throws BaseException {
        ...
        Boolean detect = systemMonitoringBiz.getDailyOrder(SystemMonitoringRequestDto.builder()
        ...
        if (detect) {
            // Send Slack
            Long batchNo = SystemEnums.MonitoringMessage.DAILY_ORDER.getBatchNo();
            String content = SystemEnums.MonitoringMessage.DAILY_ORDER.getMessage();
