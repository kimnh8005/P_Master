...
@Component("systemMonitoringMallLoginJob")
@Slf4j
public class SystemMonitoringMallLoginJob implements BaseJob {
    /*
    배치명 : 모니터링 - MALL 로그인
    배치번호 : 131
     */
    ...
    public void run(String[] params) throws BaseException {
        ...
        Boolean detect = systemMonitoringBiz.getMallLogin(SystemMonitoringRequestDto.builder()
        ...
        if (detect) {
            // Send Slack
            Long batchNo = SystemEnums.MonitoringMessage.MALL_LOGIN.getBatchNo();
            String content = SystemEnums.MonitoringMessage.MALL_LOGIN.getMessage();
