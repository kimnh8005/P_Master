...
@Component("goodsPoBaekamPf1840Job")
@Slf4j
@RequiredArgsConstructor
public class GoodsPoBaekamPf1840Job implements BaseJob {
     ...
     public void run(String[] params) {
        ...
        try {
        	...
        	batchGoodsPurchaseOrderBiz.addPffGoodsPurchaseOrderJob(PoEnums.PoBatchType.PO_BATCH_TP_BAEKAM_PF_1840.getCode(), TransferServerTypes.CJWMS.getCode());
