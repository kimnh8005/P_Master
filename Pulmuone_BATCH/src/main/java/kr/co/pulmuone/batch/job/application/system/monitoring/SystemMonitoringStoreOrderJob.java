...
@Component("systemMonitoringStoreOrderJob")
@Slf4j
public class SystemMonitoringStoreOrderJob implements BaseJob {
    /*
    배치명 : 모니터링 - 매장배송 주문 발생 여부
    배치번호 : 129
     */
    ...
    public void run(String[] params) throws BaseException {
        ...
        Boolean detect = systemMonitoringBiz.getStoreOrder(SystemMonitoringRequestDto.builder()
        ...
        if (detect) {
            // Send Slack
            Long batchNo = SystemEnums.MonitoringMessage.STORE_ORDER.getBatchNo();
            String content = SystemEnums.MonitoringMessage.STORE_ORDER.getMessage();
